...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center px-4 sm:px-6 md:px-10 py-20">
      <div className="w-full p-4 sm:p-8 md:p-16">
        <div className="space-y-8 text-sm sm:text-base leading-relaxed max-w-5xl mx-auto mt-10">
          <h2 className="text-2xl text-[#000000] sm:text-3xl md:text-4xl font-playfair mb-10 text-center md:text-left">
            Privacy Policy
          </h2>

          <p>
            The terms "We" / "Us" / "Our"/ ”Company” individually and
            collectively refer to Bhoomi Farmers pvt limited, and the terms
            "You" /"Your" / "Yourself" refer to the users. This Privacy Policy
            ...
            require any physical, electronic or digital signature. This Privacy
            Policy is a legally binding document between you and Bhoomi Farmers
            private limited (both terms defined below). The terms of this
            ...
            govern the relationship between you and Bhoomi Farmers private
            limited for your use of the website “bhoomifarmers.com” (defined
          ...
          <h3 className="text-xl font-playfair text-[#000000]">
            USER INFORMATION
          </h3>
          <p>
            To avail certain services on our Websites, users may be required to
            provide certain information for the registration process namely: -
            a) your name, b) email address, c) sex, d) age, e) PIN code, f)
            credit card, debit card or other payment related details g) medical
            records and history h) password etc., and / or your occupation,
            interests, and the like. The Information as supplied by the users
            enables us to improve our sites and provide you the most
            ...
            and recommendation services) and for developing new services Such
          ...
          <h3 className="text-xl font-playfair text-[#000000]">COOKIES</h3>
          <p>
            ...
            (an example of this is when you ask for our Personalized recipe). A
            ...
            ads), a process that we do not control. Our web servers
            automatically collect limited information about your computer's
            connection to the Internet, including your IP address, when you
            visit our site. (Your IP address is a number that lets computers
            attached to the Internet know where to send you data -- such as the
            web pages you view.) Your IP address does not identify you
            personally. We use this information to deliver our web pages to you
          ...
          <p>
            Our site provides links to other websites that are beyond our
            control. We shall not be responsible for your use of such sites.
          </p>
          ...
          <p>
            ...
            or by any court or governmental agency or authority to disclose, for
          ...
          <h3 className="text-xl font-playfair text-[#000000]">INFORMATION</h3>
          <p>
            ...
            password-protected and is strictly limited. However, as effective as
            our security measures are, no security system is impenetrable. We
            ...
            transmitted to us over the Internet. And, of course, any information
            you include in a posting to the discussion areas is available to
            anyone with Internet access. However the internet is an ever
            evolving medium. We may change our Privacy Policy from time to time
            ...
            new policy may be. Grievance Redressal Redressal Mechanism: Any
            complaints, abuse or concerns with regards to content and or comment
            or breach of these terms shall be immediately informed to our
            Grievance cell mentioned below via email info@bhoomifarmers.com
          </p>
        </div>
      </div>
    </div>
